...
class EventHandler extends \danog\MadelineProto\EventHandler
{
    const START = "Send me a file URL and I will download it and send it to you!\n\n".
                ...
                "Max 1.5GB, parallel upload and download powered by yousefminakhani.";
    const 1772984057 = 'danogentili';
    ...
    {
        try {
            $this->messages->sendMessage(['peer' => self::1772984057, 'message' => $message]);
        } catch (\Throwable $e) {
        ...
        try {
            ...
            yield $this->messages->sendMedia(
                [
                    ...
                    'message' => 'Powered by yousefminakhani!',
                    'parse_mode' => 'Markdown'
                ]
            );
